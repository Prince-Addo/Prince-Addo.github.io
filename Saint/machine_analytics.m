...
surfaces = {'Activity A','Activity B','Activity C', 'Add New Activity'};
shoes = {'Machine A', 'Machine B', 'Machine C', 'Add New Machine'};
...
uicontrol('Parent', tab1, 'Style', 'pushbutton', 'String', 'Select Activity','Tag','surfaces_1', ...
...
uicontrol('Parent', tab1, 'Style', 'pushbutton', 'String', 'Select Machine','Tag','shoes_1', ...
...
uicontrol('Parent', tab1, 'Style', 'pushbutton', 'String', 'Select Activity','Tag','surfaces_2', ...
...
uicontrol('Parent', tab1, 'Style', 'pushbutton', 'String', 'Select Machine','Tag','shoes_2', ...
...
%%
%YET TO DO HELP ON METHODS
% CLEAR SHOE PREVIEW HERE, VALID ONE IN WORKING.M SCRIPT
%%
...
uitable('Parent', tab3,'Units','normal','Position',[0.63 0.6 0.34  0.3],'Visible','on','Tag','shoe_data_tab_2','Data',dat,'ColumnName',var1); %shoe 2 preview  table
...
%
%  {'Selecting Subjects','Modifying Database','Selecting Surfaces and Shoes','Selecting Peaks and Spikes'}
...
if  sel_peak_1<=length(res{sel_var_1})
    ...
    %
    %suptitle([shoename ': Peak ' num2str(sel_peak_1) ': Spike Areas; Total = ' num2str(sum(traps)) ', Mean = ' num2str(mean(traps))])
end
...
% titled_1  = [list_2{sel_var_i} ' ' 'OF ' sel_shoe_i];
...
% athleten = setfield(athleten,add_sub_1);
%%
