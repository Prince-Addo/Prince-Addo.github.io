...
%     while vaner == 0
%         try
%             assignin('base','stater',stater)
%             [region,region_1,region_2,region_3] = fetch_data(data_ind,timer,peaks,peaks1); % fetch_data spikes and peaks
%             vaner = 1;
%         catch
%             if stater >100
%                 if stater >3000
...
expec = 500 ;%round(length(data_ind)/50);
% expec = 1500;
